...
namespace SciChart.Examples.Examples.Charts3D.CreateRealtime3DCharts {
    ...
    public partial class CreateRealTime3DSurfaceMeshChart : UserControl {
        ...
        private UniformGridDataSeries3D<int> dataSeries;
        private int i;
        private int[][] actualData;
        private int dataNumber = 1000;
        ...
        private void OnStart() {
            ...
            //var dataSeries = new UniformGridDataSeries3D<int>(w, h) {
            //    StartX = 0,
            //    StartZ = 0,
            //    StepX = 1,//0 / (w - 1d),
            //    StepZ = 1,//0 / (h - 1d),
